...
use story::{
    ButtonStory, IconStory, InputStory, ListStory, PopupStory, ScrollableStory, StoryContainer,
    SwitchStory,
};
                                ...
                                Button::new("theme-mode", cx)
                                    ...
                                    .on_click(move |_, cx| {
                                        let mode = match cx.theme().mode.is_dark() {
                                            true => ti::theme::ThemeMode::Light,
                                            false => ti::theme::ThemeMode::Dark,
                                        };
...
impl Render for LocaleSelector {
    fn render(&mut self, cx: &mut ViewContext<Self>) -> impl IntoElement {
        ...
        let locale = ti::locale().to_string();
